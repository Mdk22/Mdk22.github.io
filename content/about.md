---
title: "About"
description: "My background, current offensive security focus, learning path, and the purpose behind Mdk22 Security Write-Ups."
showToc: false
url: "/about/"
---
...
My background is in networking and routing, with a particular interest in internal networks. Cybersecurity had been on my mind for a long time, but I started turning that interest into daily practice about a year and a half ago. Since then, I have worked on it every day with one simple goal: keep improving.
...
- Proxy-based reproduction, primarily with Caido
- Burp Suite practice alongside Caido
- Terminal and CLI reproduction with `curl`, `jq`, and supporting tools
